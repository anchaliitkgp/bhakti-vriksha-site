...
export const schedule: Session[] = [
  ...
  { week: 4,  date: "2026-06-21", category: "Practical (HG Radheshyam Prabhu)", title: "Gita Tools for Great Habits", suggestedLevel: "L2/L3", suggestedSpeaker: "Shekhar Verma or Anchal Nema", notes: "Habit stacking, morning routine" },
  { week: 5,  date: "2026-06-28", category: "Gita / Core", title: "Chapter 3: Karma Yoga", suggestedLevel: "L2", suggestedSpeaker: "Shekhar Verma", notes: "Work as worship; practical" },
  { week: 6,  date: "2026-07-05", category: "Gita / Core", title: "Chapter 4: Transcendental Knowledge", suggestedLevel: "L2", suggestedSpeaker: "Anu Nehra", notes: "Parampara importance" },
  ...
  { week: 9,  date: "2026-07-26", category: "Gita / Core", title: "Chapter 6: Dhyana Yoga", suggestedLevel: "L2", suggestedSpeaker: "Shekhar Verma", notes: "Meditation and discipline" },
  ...
  { week: 12, date: "2026-08-16", category: "Practical (HG Radheshyam Prabhu)", title: "Overcoming Bad Habits (Media, Phone, Temper)", suggestedLevel: "L2", suggestedSpeaker: "Shekhar Verma", notes: "Needs authenticity; sincere practice" },
  ...
  { week: 17, date: "2026-09-20", category: "Gita / Core", title: "Chapter 10: Opulence of the Absolute", suggestedLevel: "L2", suggestedSpeaker: "Anu Nehra", notes: "Vibhuti yoga" },
  ...
  { week: 19, date: "2026-10-04", category: "Gita / Core", title: "Chapter 12: Devotional Service", suggestedLevel: "L2", suggestedSpeaker: "Shekhar Verma", notes: "26 qualities of devotee" },
  ...
  { week: 21, date: "2026-10-18", category: "Gita / Core", title: "Application Workshop: Gita in Daily Life", suggestedLevel: "L3", suggestedSpeaker: "Srirekha Pillai", notes: "Facilitated discussion" },
  { week: 22, date: "2026-10-25", category: "Gita / Core", title: "Chapter 13: Nature, Enjoyer, Consciousness", suggestedLevel: "L2", suggestedSpeaker: "Anu Nehra", notes: "Kshetra-kshetrajna" },
  { week: 23, date: "2026-11-01", category: "Gita / Core", title: "Chapter 14: Three Modes of Material Nature", suggestedLevel: "L2", suggestedSpeaker: "Shekhar Verma", notes: "Sattva/rajas/tamas" },
  ...
  { week: 27, date: "2026-11-29", category: "Gita / Core", title: "Chapter 16: Divine and Demonic Natures", suggestedLevel: "L2", suggestedSpeaker: "Anu Nehra", notes: "26 divine qualities" },
  ...
  { week: 29, date: "2026-12-13", category: "Gita / Core", title: "Chapter 17: Three Kinds of Faith", suggestedLevel: "L3", suggestedSpeaker: "Ria Pillai", notes: "Food/charity/austerity in modes" },
...
export const speakers = [
  ...
  { level: "L2", name: "Shekhar Verma", role: "Senior Practitioner", description: "Newly initiated; very sincere practice. Leads mid-complexity chapters (Ch 3, 6, 12, 14) and practical sessions on habits." },
  { level: "L2", name: "Anu Nehra", role: "Senior Practitioner", description: "Newly initiated; very sincere practice. Leads moderate chapters (Ch 4, 10, 13, 16) with a reflective, sharing-based tone." },
  ...
  { level: "L3", name: "Srirekha Pillai", role: "Facilitator", description: "Aspiring sincere practitioner. Leads application workshops and review sessions." },
  { level: "L3", name: "Ria Pillai", role: "Facilitator", description: "Aspiring sincere practitioner. Leads moderate chapters (Ch 17) with mentor support." },
